...
file_path = 'backend/src/modulos/usuarios/application/use_cases/validar_etapa_1_use_case.py'
...
class ValidarEtapa1UsuarioUseCase:
    ...
    def execute(self, dto: ValidarEtapa1CadastroUsuarioDTO, arquivo_foto: tuple | None = None) -> CadastroSucessoDTO:
        ...
        return CadastroSucessoDTO(
            message="Etapa 1 validada com sucesso",
            data=CadastroDataDTO(id=0, nome=nome, email=email, status_cadastro="em_andamento")
        )
"""
