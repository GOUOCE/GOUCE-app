...
import { Passo1DadosBasicos } from '@/components/registro/Passo1DadosBasicos';
import { Passo2Demografico } from '@/components/registro/Passo2Demografico';
import { Passo3ContatoVinculo } from '@/components/registro/Passo3ContatoVinculo';
import { Passo4Documentacao } from '@/components/registro/Passo4Documentacao';
import { TermosDeUso } from '@/components/registro/TermosDeUso';
import { TelaSucesso } from '@/components/registro/TelaSucesso';
...
export default function RegisterScreen() {
  ...
  if (enviado) {
    return <TelaSucesso onVoltarLogin={() => router.replace('/(auth)/login')} />;
  }
