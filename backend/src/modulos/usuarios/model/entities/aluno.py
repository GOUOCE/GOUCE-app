...
class AlunoORM(Base):
    ...
    identificacao_genero = Column(EncryptedString(500), nullable=False)
    tem_filhos = Column(Boolean, nullable=False)
    ...
    raca = Column(EncryptedString(500), nullable=False)
    transgenero = Column(EncryptedString(500), nullable=False)
